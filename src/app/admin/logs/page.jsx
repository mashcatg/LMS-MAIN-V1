    ...
    <main>
      ...
      <Tabs defaultValue="courses">
        <TabsList className="mb-2">
          <TabsTrigger value="AdminTraffic">Admin Traffics</TabsTrigger>
          <TabsTrigger value="StudentTraffic">Student Traffics</TabsTrigger>
          <TabsTrigger value="LoginLogs">Login Logs</TabsTrigger>
        </TabsList>
        <TabsContent value="AdminTraffic">
          <AdminTraffic />
        </TabsContent>
        <TabsContent value="StudentTraffic">
          <StudentTraffic />
        </TabsContent>
