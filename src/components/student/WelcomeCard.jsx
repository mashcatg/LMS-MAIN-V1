...
const WelcomeCard = () => {
  ...
  return (
    <div className="z-1 flex relative bg-gradient-to-r from-primary to-secondary p-6 rounded-lg animate-fadeIn overflow-hidden md:w-2/3">
      ...
      <div className="w-full flex justify-end z-10">
        ...
        >
          ...
          <defs>
            ...
            >
              <stop stop-color="var(--secondary)"></stop>
              <stop offset="1" stop-color="hsl(var(--primary))"></stop>
            </linearGradient>
            <linearGradient
